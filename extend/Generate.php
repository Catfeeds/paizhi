...
class Generate
{
    ...
    private function buildAll($pathView, $pathTemplate, $fileName, $tableName, $code, $data)
    {
		...
		$this->buildEchart($pathView, $pathTemplate, $fileName, $tableName, $code, $data);
     ...
     * @return bool
     */
    private function delEchart($pathView, $phpFile = '')
    {
        return $this->deleteFile($pathView . 'echarts.html');
    }
     ...
     * 创建 echarts.html 文件
     */
    private function buildEchart($path, $pathTemplate, $fileName, $tableName, $code, $data)
    {
        $template = file_get_contents($pathTemplate . "echarts.tpl");
        $file = $path . "echarts.html";

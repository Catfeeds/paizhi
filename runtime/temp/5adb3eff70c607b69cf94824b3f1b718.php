<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:91:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\training_coursechapter\index.html";i:1510885540;s:76:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\template\base.html";i:1488874432;s:87:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\template\javascript_vars.html";i:1488874432;s:90:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\training_coursechapter\form.html";i:1521786346;s:88:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\training_coursechapter\th.html";i:1521859801;s:88:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\training_coursechapter\td.html";i:1521859801;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="select-box" style="width:250px">
        <select name="courseid" class="select">
            ...
            <?php if(is_array($courseInfo2) || $courseInfo2 instanceof \think\Collection || $courseInfo2 instanceof \think\Paginator): $i = 0; $__LIST__ = $courseInfo2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <option value ="<?php echo $vo['id']; ?>"><?php echo $vo['courseName']; ?></option>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>


    <input type="text" class="input-text Wdate" style="width:250px" placeholder="上传时间" name="release_time" value="<?php echo \think\Request::instance()->param('release_time'); ?>"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  >
...
<td>
    <?php
       echo $course_array[$vo['courseid']];
    ?>
</td>

<td><?php echo $vo['title']; ?></td>

<!--<td><video src="__ROOT__<?php echo $vo['videos']; ?>" height="40"></video></td>-->

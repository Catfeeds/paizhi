<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:69:"C:\wwwroot\AMS\public/../application/admin\view\admin_role\index.html";i:1521610964;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;s:68:"C:\wwwroot\AMS\public/../application/admin\view\admin_role\form.html";i:1516344980;s:66:"C:\wwwroot\AMS\public/../application/admin\view\admin_role\th.html";i:1521614280;s:66:"C:\wwwroot\AMS\public/../application/admin\view\admin_role\td.html";i:1521531427;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<th width="120"><?php echo sort_by('学区名','schoolName'); ?></th>
<th width="120"><?php echo sort_by('部门名称','name'); ?></th>
<th width="80">状态</th>
<th width="150">备注</th>
            <th width="70">操作</th>
        </tr>
...
<td><?php echo $vo['remark']; ?></td>
            <td class="f-14">
                ...
                <!--<?php if (\Rbac::AccessCheck('edit')) : ?> <a title="编辑" href="javascript:;" onclick="layer_open('编辑','<?php echo \think\Url::build('edit', ['id' => $vo["id"], ]); ?>')" style="text-decoration:none" class="ml-5"><i class="Hui-iconfont">&#xe6df;</i></a><?php endif; if (\Rbac::AccessCheck('delete')) : ?> <a title="删除" href="javascript:;" onclick="del(this,'<?php echo $vo['id']; ?>','<?php echo \think\Url::build('delete', []); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a><?php endif; if (\Rbac::AccessCheck('user')) : ?> <a title="用户列表" href="javascript:;" onclick="layer_open('用户列表','<?php echo \think\Url::build('user', ['id' => $vo['id'], ]); ?>')" class="label radius ml-5 label-primary">用户列表</a><?php endif; if (\Rbac::AccessCheck('access')) : ?> <a title="授权" href="javascript:;" onclick="full_page('授权','<?php echo \think\Url::build('access', ['id' => $vo['id'], ]); ?>')" style="text-decoration:none" class="ml-5"><i class="Hui-iconfont">&#xe6df;</i></a><?php endif; ?>-->
                <?php if (\Rbac::AccessCheck('delete')) : ?> <a title="删除" href="javascript:;" onclick="del(this,'<?php echo $vo['id']; ?>','<?php echo \think\Url::build('delete', []); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a><?php endif; if (\Rbac::AccessCheck('user')) : ?> <a title="用户列表" href="javascript:;" onclick="layer_open('用户列表','<?php echo \think\Url::build('user', ['id' => $vo['id'], ]); ?>')" class="label radius ml-5 label-primary">用户列表</a><?php endif; if (\Rbac::AccessCheck('access')) : ?> <a title="授权" href="javascript:;" onclick="full_page('授权','<?php echo \think\Url::build('access', ['id' => $vo['id'], ]); ?>')" style="text-decoration:none" class="ml-5"><i class="Hui-iconfont">&#xe6df;</i></a><?php endif; ?>
            </td>
        </tr>

<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:69:"C:\wwwroot\AMS\public/../application/admin\view\admin_user\index.html";i:1507586324;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;s:68:"C:\wwwroot\AMS\public/../application/admin\view\admin_user\form.html";i:1488874432;s:66:"C:\wwwroot\AMS\public/../application/admin\view\admin_user\th.html";i:1507585994;s:66:"C:\wwwroot\AMS\public/../application/admin\view\admin_user\td.html";i:1507585966;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<td><?php echo $vo['remark']; ?></td>
            <td class="f-14">
                <?php echo show_status($vo['status'],$vo['id']); if (\Rbac::AccessCheck('edit')) : ?> <a title="编辑" href="javascript:;" onclick="layer_open('编辑','<?php echo \think\Url::build('edit', ['id' => $vo["id"], ]); ?>')" style="text-decoration:none" class="ml-5"><i class="Hui-iconfont">&#xe6df;</i></a><?php endif; if (\Rbac::AccessCheck('delete')) : ?> <a title="删除" href="javascript:;" onclick="del(this,'<?php echo $vo['id']; ?>','<?php echo \think\Url::build('delete', []); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a><?php endif; if (\Rbac::AccessCheck('password')) : ?> <a title="修改密码" href="javascript:;" onclick="layer_open('修改密码','<?php echo \think\Url::build('password', ['id' => $vo['id'], ]); ?>')" class="label radius ml-5 label-secondary">修改密码</a><?php endif; ?>

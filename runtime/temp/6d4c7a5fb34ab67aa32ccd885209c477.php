<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:81:"C:\wwwroot\AMS\public/../application/admin\view\student_access_control\index.html";i:1521250987;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;s:80:"C:\wwwroot\AMS\public/../application/admin\view\student_access_control\form.html";i:1521257105;s:78:"C:\wwwroot\AMS\public/../application/admin\view\student_access_control\th.html";i:1521191628;s:78:"C:\wwwroot\AMS\public/../application/admin\view\student_access_control\td.html";i:1521250175;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="班级名称" name="divisionName" value="<?php echo \think\Request::instance()->param('divisionName'); ?>" >
    <div class="select-box" style="width:250px">
        <select name="type" class="select">
            <option value="">请选择门禁方式</option>
    ...
    <!--<input type="text" class="input-text Wdate" style="width:250px" placeholder="出门时间" name="outTime" value="<?php echo \think\Request::instance()->param('outTime'); ?>"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  >-->
    <!--<input type="text" class="input-text Wdate" style="width:250px" placeholder="进门时间" name="inTime" value="<?php echo \think\Request::instance()->param('inTime'); ?>"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  >-->
...
<th width=""><?php echo sort_by('班级名称','divisionName'); ?></th>
<th width=""><?php echo sort_by('门禁方式','type'); ?></th>
<th width=""><?php echo sort_by('进出门时间','time'); ?></th>
<th width=""><?php echo sort_by('进出门','flag'); ?></th>
<th width=""><?php echo sort_by('关系','relation'); ?></th>
<th width="">备注</th>
            <th width="70">操作</th>
        </tr>
        </thead>
...
<td><?php echo high_light($vo['divisionName'],\think\Request::instance()->param('divisionName')); ?></td>

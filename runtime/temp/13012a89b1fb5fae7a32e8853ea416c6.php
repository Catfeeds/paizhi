<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\school_management\fsedit.html";i:1526519272;s:80:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\base.html";i:1526016189;s:91:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\javascript_vars.html";i:1526016189;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-4">
				...
				<div class="col-xs-10 col-sm-10" style="padding:10px 0 10px 20px;text-align: justify;">
					<p>上传:营业执照图片<a href="javascript:;" id="guarantee" class="btn btn-primary radius f-r">工资担保</a></p>
					<p class="c-999">照片信息需清晰可见，内容真实有效，不得做任何修改。照片支持.jpg.jepg.bmp.gif.png格式，大小不超过8M。</p>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-4">
				...
				<div class="col-xs-10 col-sm-10" style="padding:10px 0 10px 20px;text-align: justify;">
					<p>请下载《认证授权书》<a href="#" class="btn btn-primary radius f-r">点击下载附件</a></p>
					<p><span class="c-333">按要求填写，并加盖企业公章(公司法人备案的芯片章)。<br /><span class="c-red">授权人和实名认证人需为同一人!</span></span><br /><span  class="c-999">照片信息需清晰可见，内容真实有效，不得做任何修改。照片支持.jpg.jepg.bmp.gif.png格式，大小不超过8M。</span></p>
					<input type="file" size="30"/>
				</div>
            </div>
            <div class="col-xs-4 col-sm-4"></div>

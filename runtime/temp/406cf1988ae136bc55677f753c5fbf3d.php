<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:97:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\company_release_position\index.html";i:1523587046;s:80:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\base.html";i:1526016189;s:91:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\javascript_vars.html";i:1526016189;s:96:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\company_release_position\form.html";i:1523587112;s:94:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\company_release_position\th.html";i:1526290918;s:94:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\company_release_position\td.html";i:1526290909;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<td>
    ...
    <?php endif; ?>
            ...
            <td class="f-14">
                ...
                <!--只有正在上架的职位才让其刷新职位-->
                <?php if($vo['isdown'] == 0): ?>
                   <a href="<?php echo url('CompanyReleasePosition/refresh',array('id'=>$vo['id'])); ?>" style="color: #148cf1">刷新职位</a>
                <?php endif; ?>
                <!--只有正在上架的职位才让其刷新职位-->
...
<script type="text/javascript">
    function isdown(id)
    {
        $(function(){
            $.ajax({
                type:'get',//选择get方式提交
                url:'<?php echo url("CompanyReleasePosition/isdown"); ?>',//将数据提交的页面
                data:{id:id},//传值

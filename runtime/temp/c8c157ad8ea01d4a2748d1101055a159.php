<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:85:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\class_management\index.html";i:1507513122;s:76:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\template\base.html";i:1488874432;s:87:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\template\javascript_vars.html";i:1488874432;s:84:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\class_management\form.html";i:1516759304;s:82:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\class_management\th.html";i:1506625232;s:82:"C:\inetpub\wwwroot\anhui\public/../application/admin\view\class_management\td.html";i:1506625234;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	...
	<select name="schoolName" class="select" datatype="*" nullmsg="请选择学区名称" >
		...
		<?php if(is_array($all_schoolName) || $all_schoolName instanceof \think\Collection || $all_schoolName instanceof \think\Paginator): $i = 0; $__LIST__ = $all_schoolName;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		     <option value ="<?php echo $vo['schoolName']; ?>"><?php echo $vo['schoolName']; ?></option>
		<?php endforeach; endif; else: echo "" ;endif; ?>
	</select>
	</div>
    <div class="select-box" style="width:250px">
        <select name="class" class="select">
			    <option value ='' selected>请选择学级</option>
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="班级单位" name="className" value="<?php echo \think\Request::instance()->param('className'); ?>" >
    <input type="text" class="input-text" style="width:250px" placeholder="班主任" name="classTeacher" value="<?php echo \think\Request::instance()->param('classTeacher'); ?>" >
...
<th width=""><?php echo sort_by('学区名称','schoolName'); ?></th>
<th width=""><?php echo sort_by('学级','class'); ?></th>
<th width=""><?php echo sort_by('班级单位','className'); ?></th>
<th width=""><?php echo sort_by('班主任','classTeacher'); ?></th>
<th width="">备注</th>
            <th width="70">操作</th>
        </tr>
        </thead>
...
<td><?php echo high_light($vo['className'],\think\Request::instance()->param('className')); ?></td>
<td><?php echo high_light($vo['classTeacher'],\think\Request::instance()->param('classTeacher')); ?></td>
...
<script>
    $(function () {
        $("[name='class']").find("[value='<?php echo \think\Request::instance()->param('class'); ?>']").attr("selected", true);
    })
</script>

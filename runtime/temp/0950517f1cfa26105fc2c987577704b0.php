<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\pub\register.html";i:1526016189;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="loginWraper">
    <div id="loginform" class="loginBox loginBox-register">
        ...
        <form class="form form-horizontal" action="<?php echo url('Pub/evpi'); ?>" method="post" id="form">
            <div class="row cl">
            ...
            <div class="row cl">
            	<div class="col-xs-9 col-ms-9">
            		<a href="<?php echo url('Pub/login'); ?>" class="register-company">已有账号，点击登录</a>
            	</div>
               <div class="col-xs-3 col-ms-3"></div>
            </div>
        </form>
...
//        });
        ...
        $('#get_code').click(function(){
            ...
            $.ajax({
                ...
                url:"<?php echo url('Pub/send'); ?>",//将数据提交的页面
                data:{phone:phone},//传值
        ...
        $("#form").submit(function(){
            ...
            $.ajax({
                type:'post',//选择post方式提交
                url:"<?php echo url('Pub/checkRegister'); ?>", //将数据提交的页面
                ...
                success: function(data)
                {
                    ...
                    if(statusCode == 11){
                        layer.msg(arr2.msg);
                        bool = true;
//                        window.location.href="<?php echo url('pub/evpi'); ?>?phone="+phone+"";

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\wwwroot\AMS\public/../application/index\view\expression\details.html";i:1522136292;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    <div id="wrap">
        <header class="header header-fixed">
            <a href="<?php echo url('expression/index'); ?>?phone_account=<?php echo $phone_account; ?>&account=<?php echo $account; ?>&type=<?php echo $type; ?>" class="back back1"></a>
        ...
        <div class="information">
	        ...
	        <?php if($notice['images'] != ''): if(is_array($notice['images']) || $notice['images'] instanceof \think\Collection || $notice['images'] instanceof \think\Paginator): $k = 0; $__LIST__ = $notice['images'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($k % 2 );++$k;?>
				   <img src="<?php echo $vo1; ?>"  href="ios<?php echo $k-1; ?>://<?php echo $vo1; ?>" class="js-img"/>
		...
		<input type="hidden" name="nid" value="<?php echo $rid; ?>">
    ...
    $(function () {
        ...
        initJsBridge(function () {
			...
			$(".comment").click(function(){
			    ...
			    window.WebViewJavascriptBridge.callHandler('comment2', nid, function (response) {
        ...
        $(document).ready(function(){
           $(document).on('click','.click-zan',function(){
                ...
                $.ajax({
                url:'<?php echo url("expression/expressionzan"); ?>',
                type:'post',
                data:{id:rid,phone_account:phone_account},
                dataType:'json',

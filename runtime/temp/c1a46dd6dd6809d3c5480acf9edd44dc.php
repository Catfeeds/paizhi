<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"C:\wwwroot\AMS\public/../application/admin\view\school_management\index.html";i:1507449272;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;s:75:"C:\wwwroot\AMS\public/../application/admin\view\school_management\form.html";i:1507494428;s:73:"C:\wwwroot\AMS\public/../application/admin\view\school_management\th.html";i:1515203283;s:73:"C:\wwwroot\AMS\public/../application/admin\view\school_management\td.html";i:1515206928;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text" style="width:250px" placeholder="校区编号" name="schoolID" value="<?php echo \think\Request::instance()->param('schoolID'); ?>" >
    <input type="text" class="input-text" style="width:250px" placeholder="学区账号" name="schoolAccount" value="<?php echo \think\Request::instance()->param('schoolAccount'); ?>" >
...
<th width="">序号</th>
<th width=""><?php echo sort_by('校区名称','schoolName'); ?></th>
<th width="">校区区域</th>
<th width=""><?php echo sort_by('校区编号','schoolID'); ?></th>
<th width=""><?php echo sort_by('学区账号','schoolAccount'); ?></th>
<th width="">联系电话</th>
<th width="">校区地址</th>
            <th width="70">操作</th>
        </tr>
...
<td><?php echo high_light($vo['schoolID'],\think\Request::instance()->param('schoolID')); ?></td>

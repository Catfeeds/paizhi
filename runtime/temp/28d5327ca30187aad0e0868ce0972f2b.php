<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:102:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\company_release_fullposition\fsedit.html";i:1526458017;s:80:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\base.html";i:1526016189;s:91:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\javascript_vars.html";i:1526016189;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <style type="text/css">
            .search-work{width:95%;position: absolute;z-index: 5;background: #fff;border:1px solid #7A9CD3;top:40px;display: none;}
            .search-work-list a{display:block;width:20%;float:left;line-height: 2;padding-left: 20px;position: relative;}
            .search-work-list a:hover,.search-work-child>ul li:hover{background: #1E90FF;color:#fff;text-decoration: none;}
            .search-work-list a>ul{display: none;width:100%;position: absolute;left:0;background: #f5f5f5;z-index: 2;color: #333;}
            .search-work-list a>ul li{display:block;padding:0 15px}
            .search-work-list a>ul li:hover{background: #aaa;color:#fff;}
            .search-work-list a:hover ul{display: block;}
            .search-work-child{padding:10px 20px;position:relative}
            .search-work-child>ul{position: absolute;top: 40px;background: #fff;border:1px solid #7A9CD3;width:35%;display: none;z-index: 2;padding:10px 0}
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6" style="position: relative;">
                ...
                <div class="search-work">
                    ...
                    <div class="search-work-list">
                        <?php if(is_array($type) || $type instanceof \think\Collection || $type instanceof \think\Paginator): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vt): $mod = ($i % 2 );++$i;?>
                            <a href="#"><?php echo $vt['parent']; ?>
                                
                                <ul>
                                    <?php if(is_array($vt['son']) || $vt['son'] instanceof \think\Collection || $vt['son'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vt['son'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vx): $mod = ($i % 2 );++$i;?>
                                    <li><?php echo $vx['full_name']; ?></li>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <div class="select-box">
                    <select name="experience" class="select"  datatype="*" nullmsg="请选择工作经验">
                        ...
                        <?php if(is_array($experience_all) || $experience_all instanceof \think\Collection || $experience_all instanceof \think\Paginator): $i = 0; $__LIST__ = $experience_all;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ex): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo $ex['work_ex']; ?>"><?php echo $ex['actually']; ?></option>
            ...
            <div class="formControls col-xs-3 col-sm-3">
                <div class="select-box" style="padding: 0;border: none;">
                    <select name="salary1" id="salary1" class="select"  datatype="*" nullmsg="请选择薪资待遇" style="padding:4px 5px;width:45%;float: left;border:1px solid #ddd;">
                        <option value="<?php echo isset($salary1) ? $salary1 :  ''; ?>">
                            <?php
                                if (isset($salary1)){
                                    echo $salary1."k";
                                    }else{
                    ...
                    <select name="salary2" id="salary2" class="select"  datatype="*" nullmsg="请选择薪资待遇" style="padding:4px 5px;width:45%;float: left;border:1px solid #ddd;">
                            <option value="<?php echo isset($salary2) ? $salary2 :  ''; ?>">
                            <?php
                                if (isset($salary2)){
                                    echo $salary2."k";
                                    }else{

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\wwwroot\AMS\public/../application/admin\view\training_teacher_mien\fsedit.html";i:1521686520;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container" style="margin-top: 50px">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>" enctype="multipart/form-data">
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3" style="position: relative;top: 25px">头像：</label>
            <div class="formControls col-xs-6 col-sm-6">
...
-->
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3">介绍内容：</label>
            <div class="formControls col-xs-6 col-sm-6">
				<!-- 加载编辑器的容器 -->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <div class="select-box">
                    <select name="label" class="select"  datatype="*" nullmsg="请选择老师类别">
                        <option value ="<?php echo isset($vo['label']) ? $vo['label'] :  ''; ?>" selected><?php echo isset($vo['label']) ? $vo['label'] :  '请选择老师类别'; ?></option>
    ...
    $(function () {
        ...
        $('#picture').change(function(){
            ...
            $.ajax({
                ...
                url:'<?php echo url("TrainingTeacherMien/upload"); ?>',//将数据提交的页面
                contentType: false,
                processData: false,
                data:formData, //传值

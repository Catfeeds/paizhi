<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:85:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\art_tutoring\index.html";i:1526016187;s:80:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\base.html";i:1526016189;s:91:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\javascript_vars.html";i:1526016189;s:84:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\art_tutoring\form.html";i:1526016187;s:82:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\art_tutoring\th.html";i:1526016187;s:82:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\art_tutoring\td.html";i:1526016187;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	...
	<input type="text" class="input-text" style="width:250px" placeholder="请输入省" name="province" value="<?php echo \think\Request::instance()->param('province'); ?>" >
...
<form  method="post" action="<?php echo \think\Url::build('admin/ArtTutoring/upload'); ?>" enctype="multipart/form-data">
...
<th width="">序号</th>
<th width=""><?php echo sort_by('省','province'); ?></th>
<th width=""><?php echo sort_by('市','city'); ?></th>
<th width=""><?php echo sort_by('学校等级','educationLevel'); ?></th>
<th width=""><?php echo sort_by('学校性质','schoolNature'); ?></th>
<th width=""><?php echo sort_by('学校名称','schoolName'); ?></th>
<th width=""><?php echo sort_by('经办人','agent'); ?></th>
<th width="">联系电话</th>
<th width="">官网</th>
...
<td><?php echo high_light($vo['educationLevel'],\think\Request::instance()->param('educationLevel')); ?></td>
<td><?php echo high_light($vo['schoolNature'],\think\Request::instance()->param('schoolNature')); ?></td>
<td><?php echo high_light($vo['schoolName'],\think\Request::instance()->param('schoolName')); ?></td>
<td><?php echo high_light($vo['agent'],\think\Request::instance()->param('agent')); ?></td>

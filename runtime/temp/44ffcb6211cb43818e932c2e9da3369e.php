<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"C:\wwwroot\AMS\public/../application/admin\view\training_addcourse\fsedit.html";i:1521796944;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container" style="margin-top: 50px">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>" enctype="multipart/form-data">
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>课程对象：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="课程对象" name="target" value="<?php echo isset($vo['target']) ? $vo['target'] :  ''; ?>"  datatype="*" nullmsg="请填写课程对象">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="课程名称" name="courseName" value="<?php echo isset($vo['courseName']) ? $vo['courseName'] :  ''; ?>"  datatype="*" nullmsg="请填写课程名称">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3" style="position: relative;top: 25px">课程封面：</label>
            <div class="formControls col-xs-6 col-sm-6">
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>课程价格：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="课程价格" name="price" value="<?php echo isset($vo['price']) ? $vo['price'] :  ''; ?>"  datatype="*" nullmsg="请填写课程价格">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>课时：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="课时" name="period" value="<?php echo isset($vo['period']) ? $vo['period'] :  ''; ?>"  datatype="*" nullmsg="请填写课时">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text Wdate" placeholder="课程开始时间" name="startTime" value="<?php echo isset($vo['startTime']) ? $vo['startTime'] :  ''; ?>"   onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"   datatype="*" nullmsg="请填写课程开始时间">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text Wdate" placeholder="课程结束时间" name="endTime" value="<?php echo isset($vo['endTime']) ? $vo['endTime'] :  ''; ?>"   onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"   datatype="*" nullmsg="请填写课程结束时间">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>主讲人：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <div class="select-box">
                    <select name="speaker" class="select"  datatype="*" nullmsg="请选择主讲人" id="speaker">
                        <option value ="<?php echo isset($vo['speaker']) ? $vo['speaker'] :  ''; ?>" selected><?php echo isset($vo['speaker']) ? $vo['speaker'] :  '请选择主讲人'; ?></option>

                        <?php if(is_array($name) || $name instanceof \think\Collection || $name instanceof \think\Paginator): $i = 0; $__LIST__ = $name;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vm): $mod = ($i % 2 );++$i;?>
                        <option value ="<?php echo $vm['name']; ?>"><?php echo $vm['name']; ?>--------<?php echo $vm['label']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <div class="select-box">
                    <select name="type" class="select"  datatype="*" nullmsg="请选择课程类型" >
                        <option value ="<?php echo isset($vo['type']) ? $vo['type'] :  ''; ?>" selected><?php echo isset($vo['type']) ? $vo['type'] :  '请选择课程类型'; ?></option>
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>课程特色：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="课程特色" name="feature" value="<?php echo isset($vo['feature']) ? $vo['feature'] :  ''; ?>"  datatype="*" nullmsg="请填写课程特色">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3">课程介绍：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <!-- 加载编辑器的容器 -->
    ...
    $(function () {
        ...
        $('#picture').change(function(){
            ...
            $.ajax({
                ...
                url:'<?php echo url("TrainingAddcourse/upload"); ?>',//将数据提交的页面
                contentType: false,
                processData: false,
                data:formData, //传值

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"C:\wwwroot\AMS\public/../application/admin\view\admin_user\edit.html";i:1507457932;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" <?php if(isset($vo['realname'])): ?>  value="<?php echo $vo['realname']; ?>" readonly <?php else: ?> placeholder="" name="realname" datatype="*" nullmsg="请填写姓名" <?php endif; ?>>
            </div>
            <div class="col-xs-3 col-sm-3"><?php if(isset($vo['realname'])): ?><span class="label label-warning radius">不可更改</span><?php endif; ?></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" <?php if(isset($vo['mobile'])): ?>  value="<?php echo $vo['mobile']; ?>" readonly <?php else: ?> placeholder="" name="mobile" datatype="m" ignore="ignore" errormsg="手机格式错误" <?php endif; ?>>
            </div>
            <div class="col-xs-3 col-sm-3"><?php if(isset($vo['mobile'])): ?><span class="label label-warning radius">不可更改</span><?php endif; ?></div>
        </div>
        <div class="row cl">

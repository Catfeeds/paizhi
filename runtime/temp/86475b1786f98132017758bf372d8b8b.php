<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"C:\wwwroot\AMS\public/../application/admin\view\student_classroom\index.html";i:1508896550;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;s:75:"C:\wwwroot\AMS\public/../application/admin\view\student_classroom\form.html";i:1520575238;s:73:"C:\wwwroot\AMS\public/../application/admin\view\student_classroom\th.html";i:1520473183;s:73:"C:\wwwroot\AMS\public/../application/admin\view\student_classroom\td.html";i:1520653648;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <input type="text" class="input-text Wdate" style="width:250px" placeholder="课程时间" name="course_time" value="<?php echo \think\Request::instance()->param('course_time'); ?>"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  >
...
<td>
    ...
    <?php
       if(strlen($vo['morning'])>1){
          $arr = explode(',',$vo['morning']);
          $str = '';
          foreach($arr as $v){
             if($v!=''){
                $str.=$course_array[$v].',';
...
<td>
    ...
    <?php
       if(strlen($vo['afternoon'])>1){
          $arr = explode(',',$vo['afternoon']);
          $str = '';
          foreach($arr as $vv){
              if($vv!=''){
                  $str.=$course_array[$vv].',';
          ...
          echo trim($str,',');
             ...
             echo $course_array[$vo['afternoon']];
       }else{
            echo $vo['afternoon'];
       }

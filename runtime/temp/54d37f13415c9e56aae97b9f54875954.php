<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"C:\wwwroot\AMS\public/../application/admin\view\employee_management\edit.html";i:1521777799;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <div class="select-box">
                    <select name="divisionName" id="divisionName" class="select" datatype="*" nullmsg="请选择部门名称">
						<option value ="<?php echo isset($vo['divisionName']) ? $vo['divisionName'] :  ''; ?>" selected><?php echo isset($vo['divisionName']) ? $vo['divisionName'] :  '请选择部门名称'; ?></option>
                        <?php if(is_array($data_d) || $data_d instanceof \think\Collection || $data_d instanceof \think\Paginator): $i = 0; $__LIST__ = $data_d;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
							<option value ="<?php echo $vo1['divisionName']; ?>"><?php echo $vo1['divisionName']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
        ...
        <div class="row cl" id="classNameClass">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>班级名称：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <div class="select-box">
                    <select name="className" id="className" class="select" datatype="*" nullmsg="请选择班级名称">
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>身份：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <div class="select-box">
                    <select name="identity" class="select" datatype="*" nullmsg="请选择身份">
                        <option value ="<?php echo isset($vo['identity']) ? $vo['identity'] :  ''; ?>" selected><?php echo isset($shengfen) ? $shengfen :  '请选择身份'; ?></option>
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>员工账号：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="员工账号" id="account" name="account" value="<?php echo isset($vo['account']) ? $vo['account'] :  ''; ?>" readonly  datatype="*" nullmsg="请填写学区账号">
            </div>
        ...
        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>身份证号码：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="身份证号码" name="cardID" value="<?php echo isset($vo['cardID']) ? $vo['cardID'] :  ''; ?>"  datatype="/(^\d{15}$)|(^\d{17}(\d|X)$)/" nullmsg="请填写身份证号码">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-3 col-sm-3"><span class="c-red">*</span>岗位：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="岗位" name="postName" value="<?php echo isset($vo['postName']) ? $vo['postName'] :  ''; ?>"  datatype="*" nullmsg="请填写岗位">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" placeholder="电话" name="iphone" value="<?php echo isset($vo['iphone']) ? $vo['iphone'] :  ''; ?>"  datatype="/(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}/" nullmsg="请填写电话">
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
...
<script>
    $(function () {
        ...
        /*
        $('#divisionName').change(function(e){
            var divisionNameStr = document.getElementById("divisionName").value;
            alert(divisionNameStr);
            
            if(divisionNameStr == "教工部")
            {
                //document.getElementById("className").value = "无"；
                $("#className").prepend("<option value='无'>无</option>");
                $("#className option[text='无']").attr("selected", true);
                //$("#className").attr("value","无");
                $("#classNameClass").hide();
...
';
        ...
        $(document).on("click", ".op-add", function () {
            ...
            $(this).closest("tr").fadeOut(undefined, undefined, function () {
				...
				if(id!=''){
					$.ajax({
						url:'<?php echo \think\Url::build("EmployeeManagement/dellinkman"); ?>',
						type:'post',
						data:{'id':id},

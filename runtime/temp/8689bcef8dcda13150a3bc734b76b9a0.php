        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <div class="select-box">
                    <select name="type" class="select"  datatype="*" nullmsg="请选择角色类型">
                        <option value="<?php echo isset($vo['type']) ? $vo['type'] :  ''; ?>"><?php echo isset($vo['type']) ? $vo['type'] :  '请选择角色类型'; ?></option>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"C:\wwwroot\AMS\public/../application/admin\view\training_mien\fsedit.html";i:1521428882;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    $(function () {
        ...
        $('#picture').change(function(){
            ...
            $.ajax({
                ...
                url:'<?php echo url("TrainingMien/upload"); ?>',//将数据提交的页面
                contentType: false,
                processData: false,
                data:formData, //传值

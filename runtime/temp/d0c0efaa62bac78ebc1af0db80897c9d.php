<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\index\index.html";i:1526016188;s:91:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\javascript_vars.html";i:1526016189;s:84:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\nav_left.html";i:1526016189;s:84:"D:\demo\PHPTutorial\WWW\AMS2\public/../application/admin\view\template\nav_menu.html";i:1526016189;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="<?php echo \think\Url::build('/admin'); ?>">
		            <strong style="font-size:20px;"> 
		            <?php if(\think\Session::get('type') != 0): ?>
                          <?php echo \think\Session::get('schoolName'); endif; ?>
					</strong>后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="<?php echo \think\Url::build('/admin'); ?>">tp</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs"></span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover"> 
						<a href="#" class="dropDown_A"><?php echo \think\Session::get('real_name'); ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onclick="layer_open('个人信息', '<?php echo \think\Url::build('Pub/profile'); ?>')">个人信息</a></li>
                            <li><a href="javascript:;" onclick="layer_open('修改密码', '<?php echo \think\Url::build('Pub/password'); ?>')">修改密码</a></li>
                            <li><a href="javascript:;" onclick="logout()">退出</a></li>
                        </ul>
                    </li>
                    <!--园长信箱-->
                    <li id="Hui-msg">
                        <a href="javascript:;" onclick="layer_open('校长信箱', '<?php echo \think\Url::build('Pub/message'); ?>');this.firstElementChild.innerHTML='';" title="留言消息">
                    ...
                    <!--请假消息-->
                    <li id="Hui-msg">
                        <a href="javascript:;" onclick="layer_open('请假消息', '<?php echo \think\Url::build('Pub/info'); ?>');this.firstElementChild.innerHTML='';" title="请假消息">

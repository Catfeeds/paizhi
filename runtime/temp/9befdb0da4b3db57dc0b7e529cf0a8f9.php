<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:65:"C:\wwwroot\AMS\public/../application/admin\view\recipe\index.html";i:1508896582;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;s:64:"C:\wwwroot\AMS\public/../application/admin\view\recipe\form.html";i:1520494271;s:62:"C:\wwwroot\AMS\public/../application/admin\view\recipe\th.html";i:1520493162;s:62:"C:\wwwroot\AMS\public/../application/admin\view\recipe\td.html";i:1520822950;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<td><?php echo $vo['releaser']; ?></td>
<td><?php echo $vo['schoolName']; ?></td>
<td><?php echo $vo['release_time']; ?></td>
<td><?php echo $vo['eat_time']; ?></td>
<td><?php echo $vo['type']; ?></td>

<td>

    <?php
       if(strlen($vo['breakfast'])>1){
           $arr = explode(',',$vo['breakfast']);
           $str = '';
           foreach($arr as $v){
               if($v!=''){
                  $str.=$breakfast_array[$v].',';
               }

           }
           echo trim($str,',');
       }elseif(strlen($vo['breakfast']) == 1){
               echo $breakfast_array[$vo['breakfast']];
       }else{
               echo $vo['breakfast'];
       }
...
<td>
    ...
    <?php
       if(strlen($vo['lunch'])>1){
           $arr = explode(',',$vo['lunch']);
           $str = '';
           foreach($arr as $v){
              if($v!=''){
                 $str.=$lunch_array[$v].',';
...
<td>
    ...
    <?php
       if(strlen($vo['snack'])>1){
           $arr = explode(',',$vo['snack']);
           $str = '';
           foreach($arr as $v){
              if($v!=''){
                  $str.=$snack_array[$v].',';

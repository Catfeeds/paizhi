<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\wwwroot\AMS\public/../application/index\view\teacherlogin\index.html";i:1511242672;}*/ ?>
...
<body class="login">
    ...
    <form class="login_box" method="post" id="form">
       ...
       <a href="<?php echo \think\Url::build('Parentlogin/index'); ?>" class="login_lx">家长登录</a>
    </div>
    <div id="errM"></div>
</body>

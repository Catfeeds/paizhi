<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"C:\wwwroot\AMS\public/../application/admin\view\note\fsedit.html";i:1508895538;s:66:"C:\wwwroot\AMS\public/../application/admin\view\template\base.html";i:1488874432;s:77:"C:\wwwroot\AMS\public/../application/admin\view\template\javascript_vars.html";i:1488874432;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <div class="select-box">
                    <select name="type" class="select"  datatype="*" nullmsg="请选择类型">
						<option value="<?php echo isset($vo['type']) ? $vo['type'] :  ''; ?>"><?php echo isset($vo['type']) ? $vo['type'] :  ''; ?></option>
                        <option value="成长日记">成长日记</option>
                    </select>
                </div>
            </div>
            <div class="col-xs-3 col-sm-3"></div>

...
//    }
	...
	public function upload()
    {
        ...
        $info = $file->validate(['size'=>4194304,'ext'=>'jpg,png,gif,jepg,bmp'])->move(ROOT_PATH . 'public' . DS . 'uploads'.DS.'file');
        if($info){
        // 成功上传后 获取上传信息
         ...
         // 输出 20160820/42a79759f284b767dfcb2a0197904287.jpg
		    ...
		    if($num == '1'){
				$data['business_license'] = '/uploads/file/'.str_replace('\\','/',$info1);
				
		    }else{
				$data['authorization'] = '/uploads/file/'.str_replace('\\','/',$info1);

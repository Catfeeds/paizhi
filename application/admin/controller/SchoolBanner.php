...
//校区首页banner图
class SchoolBanner extends Controller
{
...
//            $map['release']=["like", "%" . $info1['realname']. "%"];
    ...
    public function fsedit()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $schoolName = $this->request->param("schoolName"); //获取校区名称
            ...
            $banner_link = $this->request->param('banner_link'); //跳转链接----可以为空



            //获取当前上传的图片路径
            $path = $this->request->param('path'); //字符串，形如    /uploads/file/20180314/3bf5a01asdasdb66d3c.jpg
            if($path){
                $data = array(
            ...
            Db::name("SchoolBanner")->where('id',$id)->update($data);
    ...
    public function fadd()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $banner_link = $this->request->param('banner_link');//跳转链接
            ...
            if($path){
                ...
                $data = array(
                    'schoolName' => $schoolName,
                    'schoolAccount' => $schoolAccount,
                    'banner_img' => '/uploads/file/033fc20efb497505073ed7ff96f84088.png', //默认banner
                    'banner_link' => $banner_link
                );
            }


            Db::name("SchoolBanner")->insert($data);

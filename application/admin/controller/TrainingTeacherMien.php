...
// 培训----名师风采
class TrainingTeacherMien extends Controller
{
...
//            $map['release']=["like", "%" . $info1['realname']. "%"];
    ...
    public function fsedit()
    {
        ...
        if($this->request->isPost()) {
            $id = $this->request->param("id"); //当前记录的id
            ...
            Db::name("TrainingTeacherMien")->where('id',$id)->update($data);
    ...
    public function fadd()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if(!$path){
                $data['image'] = '/uploads/file/033fc20efb497505073ed7ff96f84088.png';  //默认头像
            }else{
                $data['image'] = $path;
            }
            ...
            Db::name("TrainingTeacherMien")->insert($data);
